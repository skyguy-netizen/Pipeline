...
process extractMS3data {
    ...
    output:
    // file "intermediate_${task.index}.mgf"
    file "ms3.mgf"

    """
    python $TOOL_FOLDER/extractandformatms3.py $input intermediate_${task.index}.mgf ms3.mgf
    """
}
...
workflow {
    ...
    checkSubFormula(uniq_data.collate(1))
